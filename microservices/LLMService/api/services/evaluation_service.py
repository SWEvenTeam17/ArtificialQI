...
class EvaluationService:
    @staticmethod
    def get_semantic_evaluation(expected_answer: str, llm_answer: str)->int:
        """
    ...
    @staticmethod
    def get_external_evaluation(llm_provider: str, expected_answer: str, llm_answer: str)->int|str:
        """
