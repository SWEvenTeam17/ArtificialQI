...
def test_get_all_prompts_success(mock_serializer, mock_service, client, base_url, prompt):
...
# --- GET ALL EXCEPTION ---
@patch("API.views_def.prompt_view.PromptService.read_all", side_effect=Exception("Errore get all"))
...
# --- GET BY ID EXCEPTION ---
@patch("API.views_def.prompt_view.PromptService.read", side_effect=Exception("Errore get by id"))
...
def test_post_prompt_success(mock_serializer, mock_service, client, session):
    valid_data = {"prompt_text": "Test?", "expected_answer": "42", "session": session.id}
...
# --- POST EXCEPTION ---
@patch("API.views_def.prompt_view.PromptService.create", side_effect=Exception("Errore post"))
@patch("API.views_def.prompt_view.PromptSerializer")
...
def test_put_prompt_success(mock_serializer, mock_service, client, prompt, session):
    updated_data = {"prompt_text": "Updated?", "expected_answer": "43", "session": session.id}
    instance = mock_serializer.return_value
    instance.is_valid.return_value = True
...
# --- PUT EXCEPTION ---
@patch("API.views_def.prompt_view.PromptService.update", side_effect=Exception("Errore put"))
@patch("API.views_def.prompt_view.PromptSerializer")
...
# --- DELETE EXCEPTION ---
@patch("API.views_def.prompt_view.PromptService.delete", side_effect=Exception("Errore delete"))
